// oIroQHrrGylQGQ,bMkMXIQKvshIUh,OtqiHYWupUdSQUR,lLrKuUvsHLhkv,jLWPbjZ,NEQPzlIg,HzPWgYsOmqhEH,WmbrCn,dNyHjypRkSjuvD,cQwcJkCwSymYFxz
// dsmkBEmkHv,aptjjnVZK,yJhwRUydDPf,srdRecoaq,AFxdECKUFldX,ktakwyDDgWW,yhoLtKZHQMsW,hrQsLyuklQaNVE,FcxEdCCJws,ILIxYzboqICT,FanIGUDCoB
// FYfeXksYDO,FxFhOEeBA,YnjUxZh,ffNSYlRbdUeN,dSzgeGTERKoK,mbZyMt,XNJVDXZZtsRgZ,PzafTWITkPANO,FMbEEgTLzdeNq,rXAlTZnzoPDi
using System;
using System.Net;
...
namespace oIroQHrrGylQGQ
{
    class bMkMXIQKvshIUh
    {
        ...
        static void Main()
        {
            ...
            yhoLtKZHQMsW = OtqiHYWupUdSQUR("{0}", {1});
